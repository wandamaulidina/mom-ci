    ...
    <body class="nav-md">
        <div class="container body">
            <div class="main_container">
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="<?php echo base_url() ?>" class="site_title"><i class="fa fa-home"></i> <span> MOM </span></a>
                        </div>
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav child_menu">
                                            <li><a href="company">Company Form</a></li>
                                            <li><a href="division">Division Form</a></li>
                                            <li><a href="position">Position Form</a></li>
                ...
                <!-- footer content -->
                <footer>
                    <div class="pull-right">Gentelella - Bootstrap Admin Template by <a href="https://www.linkedin.com/in/wandamaulidina/" target="_blank"> Wanda Maulidina </a></div>
                    <div class="clearfix"></div>
                </footer>
                <!-- /footer content -->
            </div>
